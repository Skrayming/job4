...
function OpenMenuAccueilPolice() 
    if open then 
        ...
        exports['okokNotify']:Alert("Police Nationale", "Votre message a bien été envoyé aux agents", 5000, 'success')
...
local npc = {
	{hash="s_m_y_cop_01", x = 442.6279138, y = -981.92144, z = 30.689573, a = 94.3937},
}
